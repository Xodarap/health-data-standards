      ...
      class PatientImporter
        ...
        def initialize
          ...
          @section_importers[:procedures] = [generate_importer(CDA::ProcedureImporter, "./cda:entry/cda:observation[cda:templateId/@root = '2.16.840.1.113883.10.20.24.3.59']", '2.16.840.1.113883.3.560.1.57', 'performed'), #physical exam performed
                                             ...
                                             #generate_importer(CDA::ProcedureImporter, "./cda:entry/cda:act[@negationInd='true'][cda:templateId/@root = '2.16.840.1.113883.10.20.24.3.4']", '2.16.840.1.113883.3.560.1.129'), #comm from provider to provider
                                             ...
                                             #generate_importer(ProcedurePerformedImporter, "./cda:entry/cda:procedure[@negationInd='true'][cda:templateId/@root = '2.16.840.1.113883.10.20.24.3.64']", '2.16.840.1.113883.3.560.1.106'), #btw
                                             ...
                                             #generate_importer(CDA::ProcedureImporter, "./cda:entry/cda:observation[@negationInd='true'][cda:templateId/@root = '2.16.840.1.113883.10.20.24.3.18']", '2.16.840.1.113883.3.560.1.103', 'performed'), #diagnostic study performed
